...
scc_vector <- c(scc0.025, scc0.5, scc0.75, scc1, scc2, scc3, scc4, scc5, scc6)
dr <- c(0.25, 0.5, 0.75, 1, 2, 3, 4, 5, 6)
scc_table <- data.frame(scc_vector, dr)

# plotting SCC vs. discount rate
ggplot(data = scc_table, aes(x = dr, y = scc_vector)) +
    geom_line() +
  geom_col(size = 3, fill = "firebrick") +
  ...
  geom_text(aes(x = 0.25, y = -3, label = ".25"), size = 3.2, color = "black") +
  geom_text(aes(x = 0.5, y = -3, label = ".5"), size = 3.2, color = "black") +
  geom_text(aes(x = 0.75, y = -3, label = ".75"), size = 3.2, color = "black")
```
...
ggplot(data = scc_table, aes(x = dr, y = scc_vector)) +
    geom_line(alpha = 0.7) +
  geom_col(size = 3, fill = "firebrick", alpha = 0.7) +
  labs(x = "Discount rate (%)", y = "Social cost of carbon") +
  theme_minimal(14) +
  scale_x_continuous(n.breaks = 10) +
